...
const manualElectionResults2022ByTemplateId = {
  ...
  "south-iii": {
    candidates: [
      ...
      { name: "علي حسن خليل", sect: "Shia", list: "الأمل و الوفاء", votes: 13155, minorDistrict: "Marjeyoun-Hasbaya" },
      { name: "علي رشيد فياض", sect: "Shia", list: "الأمل و الوفاء", votes: 37047, minorDistrict: "Nabatieh" },
      { name: "قاسم عمر هاشم", sect: "Sunni", list: "الأمل و الوفاء", votes: 1215, minorDistrict: "Marjeyoun-Hasbaya" },
      { name: "مروان سليم خير الدين", sect: "Druze", list: "الأمل و الوفاء", votes: 2634, minorDistrict: "Marjeyoun-Hasbaya" },
      { name: "اسعد حليم حردان", sect: "Greek Orthodox", list: "الأمل و الوفاء", votes: 1859, minorDistrict: "Marjeyoun-Hasbaya" },
      { name: "حسن نظام الدين فضل الله", sect: "Shia", list: "الأمل و الوفاء", votes: 43324, minorDistrict: "Bint Jbeil" },
      { name: "ايوب فهد حميد", sect: "Shia", list: "الأمل و الوفاء", votes: 6745, minorDistrict: "Marjeyoun-Hasbaya" },
      ...
      { name: "علي احمد مراد", sect: "Shia", list: "معاً نحو التغيير", votes: 2960, minorDistrict: "Marjeyoun-Hasbaya" },
      { name: "ابراهيم محمود عبد الله", sect: "Shia", list: "معاً نحو التغيير", votes: 651, minorDistrict: "Marjeyoun-Hasbaya" },
      { name: "الياس فارس جراده", sect: "Greek Orthodox", list: "معاً نحو التغيير", votes: 9218, minorDistrict: "Marjeyoun-Hasbaya" },
      { name: "فراس اسماعيل حمدان", sect: "Druze", list: "معاً نحو التغيير", votes: 4859, minorDistrict: "Marjeyoun-Hasbaya" },
      { name: "محمد عبد اللطيف قعدان", sect: "Sunni", list: "معاً نحو التغيير", votes: 1059, minorDistrict: "Marjeyoun-Hasbaya" },
      { name: "نزار ابراهيم رمال", sect: "Shia", list: "معاً نحو التغيير", votes: 465, minorDistrict: "Marjeyoun-Hasbaya" },

      { name: "عباس محمد شرف الدين", sect: "Shia", list: "صوت الجنوب", votes: 74, minorDistrict: "Bint Jbeil" },
      { name: "كريم علي حمدان", sect: "Druze", list: "صوت الجنوب", votes: 7, minorDistrict: "Marjeyoun-Hasbaya" },
      { name: "رياض حسين عيسى", sect: "Sunni", list: "صوت الجنوب", votes: 18, minorDistrict: "Marjeyoun-Hasbaya" },
...
const generatedCandidateOverrides2022ByTemplateId = {
  ...
  "south-iii": {
    minorDistrictByCandidateName: {
      ...
      "علي حسن خليل": "Marjeyoun-Hasbaya",
      "علي رشيد فياض": "Nabatieh",
      "قاسم عمر هاشم": "Marjeyoun-Hasbaya",
      "مروان سليم خير الدين": "Marjeyoun-Hasbaya",
      "اسعد حليم حردان": "Marjeyoun-Hasbaya",
      "حسن نظام الدين فضل الله": "Bint Jbeil",
      "ايوب فهد حميد": "Marjeyoun-Hasbaya",
      "اشرف نزيه هاشم بيضون": "Bint Jbeil",

      "عباس محمد شرف الدين": "Bint Jbeil",
      "كريم علي حمدان": "Marjeyoun-Hasbaya",
      "رياض حسين عيسى": "Marjeyoun-Hasbaya",
      ...
      "علي احمد مراد": "Marjeyoun-Hasbaya",
      "ابراهيم محمود عبد الله": "Marjeyoun-Hasbaya",
      "الياس فارس جراده": "Marjeyoun-Hasbaya",
      "فراس اسماعيل حمدان": "Marjeyoun-Hasbaya",
      "محمد عبد اللطيف قعدان": "Marjeyoun-Hasbaya",
      "نزار ابراهيم رمال": "Marjeyoun-Hasbaya"
    }
  },
  "north-ii": {
    minorDistrictByCandidateName: {
