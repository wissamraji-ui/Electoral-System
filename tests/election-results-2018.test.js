...
const VERIFIED_2018_TEMPLATE_IDS = ["beirut-i", "bekaa-iii", "mount-lebanon-i", "mount-lebanon-ii", "mount-lebanon-iii", "north-iii", "south-i", "south-ii"];
...
test("2018 baselines are exposed only for verified districts", () => {
  ...
  assert.equal(hasElectionResults2018("bekaa-ii"), false);
